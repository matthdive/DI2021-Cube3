...
function Layout() {
    return (
        <div>
                <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                    <div className="container flex flex-wrap justify-between items-center mx-auto">
                        <a href="https://flowbite.com" className="flex items-center">
                            <img src="/public/images/screaming-logo.webp" className="mr-3 h-6 sm:h-9"
                                 alt="Flowbite Logo"/>
                            <span
                                className="self-center text-xl text-[#E84545]  font-provoke whitespace-nowrap">Screaming</span>
                        </a>
                        <div className="flex items-center md:order-2">
                            <button type="button"
                                ...
                                <img className="w-8 h-8 rounded-full" src="/public/images/avatar-1.jpeg"
                                     alt="user photo"/>
                            </button>
                            ...
                            <div
                                ...
                                id="dropdown"
                                style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1015px, 924.5px, 0px);"
             ...
             {/*    <nav className="bg-[#1D1D1D] border-gray-200 px-2 sm:px-4 py-2.5">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="https://flowbite.com" className="flex items-center">
                        <img src="/images/screaming-logo.webp" className="mr-3 h-12 sm:h-12" alt="Screaming Logo"/>
                            <span
                                className="self-center text-xl text-[#E84545]  font-provoke whitespace-nowrap">Screaming</span>
                    </a>
